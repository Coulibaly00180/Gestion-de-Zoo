...
class AnimalController extends AbstractController
{
    ...
    public function ajouterAnimal(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            // On recupere l'id de enclo pour effectuer certaines vérifaction pour nos conditions
            ...
            // Compter tout les enregistrement de la base de données et comparé avec le nombre
            $nombreAnimauxEnclo = $encloRecup->getAnimals()->count();

            if( ($encloRecup->getNbMaximalAnimaux()) == $nombreAnimauxEnclo){
            ...
            // Si le sexe de l'animal est inconnu alors il ne peut être stérilisé automatique
            ...
            // Vérifie si l'enclos est en quarantaine, automatiquement l'animal sera mis en quarantaine
            if ( $encloRecup->isQuarantaine() == true ){
